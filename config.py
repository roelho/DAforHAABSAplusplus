...
tf.app.flags.DEFINE_integer("EDA_replacement", 0, "number of replacement augmentations")
tf.app.flags.DEFINE_integer("EDA_insertion", 0, "number of insertion augmentations")
